...
const Card = ({user}) => {
  return (
    <div className='flex flex-col items-center w-[19vw]  border-2 p-2 m-2 rounded-md  shadow-2xl shadow-zinc-900'>
      ...
      <p className='my-2 text-sm h-20'>Description: {`${user.description.substring(0,120)}...`}</p>
